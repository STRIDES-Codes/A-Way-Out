...
save "$datafinal/data_usa_demo&age_race", replace 
...
merge m:m year state_name age_group using "$datatemp/comorbidities_obesity_BRFSS_2017_race"
	drop if _merge == 1
	drop _merge
merge m:m year state_name age_group using "$datatemp/comorbidities_highblood_BRFSS_2017_rage"
	drop if _merge == 1
	drop _merge 
